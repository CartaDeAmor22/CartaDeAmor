(function(){
  ...
  // A carta usa #carta na mesma página. Assim o elemento <audio> NÃO é destruído
  // e a música continua exatamente de onde estava ao clicar em "Abrir minha carta".
  function showCartaFromHash(){
    if(window.location.hash === "#carta") {
      const carta = document.getElementById("carta");
      if(carta) setTimeout(function(){ carta.scrollIntoView({behavior:"smooth", block:"start"}); }, 50);
    }
  }
  window.addEventListener("hashchange", showCartaFromHash);
